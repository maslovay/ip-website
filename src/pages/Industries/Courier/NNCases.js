...
class NNCases extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activeTab: "1",
          ...
          <Row className="justify-content-center">
            <Col xs="12" className="text-center">
              <div className="section-title mb-4 pb-2">
                ...
                >
                  {i18next.t('wasteneuralnetwork.titlenn')}
                </h4>
              </div>
            </Col>
          </Row>
              ...
              >
                  ...
                  >
                    <div className="text-center pt-1 pb-1">
                      <h6 className="title font-weight-normal mb-0">
                        {i18next.t('wasteneuralnetwork.titlenn1')}
                      </h6>
                    </div>
                  </NavLink>
                </NavItem>
                ...
                <NavItem>
                  ...
                  >
                    <div className="text-center pt-1 pb-1">
                      <h6 className="title font-weight-normal mb-0">
                      {i18next.t('wasteneuralnetwork.titlenn2')}
                      </h6>
                    </div>
                  </NavLink>
                </NavItem>
                ...
                <NavItem>
                  ...
                  >
                    <div className="text-center pt-1 pb-1">
                      <h6 className="title font-weight-normal mb-0">
                      {i18next.t('wasteneuralnetwork.titlenn3')}
                      </h6>
                    </div>
                  </NavLink>
                </NavItem>
