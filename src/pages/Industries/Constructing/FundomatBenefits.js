...
import img2 from "../../../assets/images/fundomat/ai_module_background.png";

class FundomatBenefits extends Component {
          ...
          <Row className="align-items-center">
            ...
            <Col lg="6" md="7" className="mt-5 mt-sm-0">
              <div className="section-title">
                <h4 className="title mb-4">{i18next.t('cvrvm.title2')}</h4>
                <p className="text-muted"> {i18next.t('cvrvm.description2')} </p>
                <ul
...
export default FundomatBenefits;
